...
import (
	...
	listener "github.com/wondenge/at-notifiers"
...
func main() {
	...
	var (
		africastalkingSvc africastalking.Service
		healthSvc         health.Service
	)
	{
		africastalkingSvc = listener.NewAfricastalking(logger)
	...
	var (
		africastalkingEndpoints *africastalking.Endpoints
		healthEndpoints         *health.Endpoints
	)
	{
		africastalkingEndpoints = africastalking.NewEndpoints(africastalkingSvc)
	...
	case "local":
		{
			...
			handleHTTPServer(ctx, u, africastalkingEndpoints, healthEndpoints, &wg, errc, logger, *dbgF)
		}
