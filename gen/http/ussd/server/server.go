...
// Server lists the ussd service endpoint HTTP handlers.
type Server struct {
	Mounts       []*MountPoint
...
// New instantiates HTTP handlers for all the ussd service endpoints using the
...
func (s *Server) Service() string { return "ussd" }
...
// Mount configures the mux to serve the ussd endpoints.
...
// and calls the "ussd" service "ussdNotifier" endpoint.
func NewUssdNotifierHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.MethodKey, "ussdNotifier")
		ctx = context.WithValue(ctx, goa.ServiceKey, "ussd")
